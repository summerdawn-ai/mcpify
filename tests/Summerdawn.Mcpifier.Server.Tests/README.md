# Summerdawn.Mcpifier.Server.Tests

This project contains integration tests for the Mcpifier server, demonstrating testability improvements that allow both HTTP and stdio modes to be tested in-process.
